<?php
	...
	$insertar = $conex->consulta("INSERT INTO comentario_noticia(id_usuario,id_noticia,titulo,descripcion,fecha) VALUES (".$idUsuario.",".$idNoticia.",'".$titulo."','".$descripcion."',NOW())",$conex);
	if (!$insertar){
