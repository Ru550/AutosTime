<?php
	...
	$qryPrimNoticia="Select noticia.id_noticia, noticia.titulo, noticia.resumen, noticia.fecha, count(id_comentario_noticia) as cont_comentarios, noticia.cont_visitas, foto_noticia.ubicacion_foto From noticia left Join comentario_noticia on noticia.id_noticia = comentario_noticia.id_noticia left Join foto_noticia on noticia.id_noticia = foto_noticia.id_noticia where foto_noticia.numero_foto > 0 group by noticia.id_noticia Order By noticia.id_noticia Desc Limit 1 ";
...
/*	$resultsPrimNoticia = mysql_query($qryPrimNoticia);
	$resultsNoticias = mysql_query($qryNoticias);
	$resultsSelfie = mysql_query($qrySelfie);
	$resultsHumor = mysql_query($qryHumor);*/
?>
		...
		<div class="general-inner">
			...
			<div class="general-text two">
				...
				?>
                    ...
                    <p><i class="glyphicon glyphicon-time"></i> <?php echo date("d/m/Y", strtotime($rowNoticias['fecha_alta']));?>
