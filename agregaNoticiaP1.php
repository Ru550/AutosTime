	...
	<div class="full">	
		...
		<div class="col-md-9 main">
			<div class="gallery-section">	   
                ...
                <h3 class="tittle"><?php echo $_SESSION['apodo']; ?>!&nbsp&nbsp&nbsp Agrega la Noticia <i class="glyphicon glyphicon-picture"></i></h3>
                	<div class="sign-up-form">
                        <div class="sign-up">
                            <table>
                                ...
                                <tr>
                                    <td align="left">
                                        Captura todos los campos con la descripción de la noticia y presiona el botón Siguiente.
                                    </td>
                                </tr>
                            </table>
                            <br />
                            <form action="agregaNoticiaP2.php" method="post" enctype="multipart/form-data" name="noticia">
                                <div class="sign-u">
                                    <div class="sign-up1">
